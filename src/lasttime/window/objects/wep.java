...
public class wep extends GameObject {
	 private Animation enwalk;
	private Handler handler;
	
	Texture tex = Game.getInstance();
	public wep(float x, float y,Handler handler, ObjectId id) {
		super(x, y, id);
	...
	public void render(Graphics g) {
		Font fnt0= new Font("arial",Font.BOLD,8);
		g.setFont(fnt0);
		g.setColor(Color.blue);
		g.drawImage(tex.wep, (int)x, (int)y, null);	
		g.drawString("New Weapon", (int)x-10, (int)y-10);	
		/*
